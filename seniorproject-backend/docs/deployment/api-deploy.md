# KahrabaIQ API Cloud Run Deployment
...
```bash
curl https://YOUR_KAHRABAIQ_API_URL/api/health
curl https://YOUR_KAHRABAIQ_API_URL/api/home/home_001/dashboard
```
...
curl -X POST \
  ...
  https://YOUR_KAHRABAIQ_API_URL/api/home/home_001/devices/breaker_01/command
```
...
flutter run -d emulator-5554 \
  --dart-define=BACKEND_API_URL=https://YOUR_KAHRABAIQ_API_URL
```
